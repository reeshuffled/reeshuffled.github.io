      ...
      i(e, [
        {
          ...
          value: function (t) {
            ...
            n
              ? ((t.fillStyle = n),
                t.beginPath(),
                t.ellipse(e.x * h, e.y * h, i.x * h, i.y * h, o, 0, 2 * Math.PI),
                t.fill())
              : s &&
          ...
          value: function (t, e) {
            ...
            (i.x > s && (this.confettiSpeed.x -= n * t),
              ...
              (this.currentPosition.y =
                this.initialPosition.y - i.y * this.absSin * c + (0.00125 * Math.pow(c, 2)) / 2),
      ...
      i(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              !this.shapes.length &&
              (null === (t = this.resolvePromise) || void 0 === t || t.call(this), !0)
            );
          },
        },
        {
          ...
          value: function (t, e, i) {
            ...
            this.shapes = this.shapes.filter(function (t) {
              return (
                t.updatePosition(s, o), t.draw(n.canvasContext), !i || t.getIsVisibleOnCanvas(e)
              );
            });
          },
        },
