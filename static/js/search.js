...
(function () {
  ...
  /* removed: const _$LiteralSearchStrategy_6 = require('./SearchStrategies/LiteralSearchStrategy') */ function NoSort() {
    return 0;
  }
  ...
  (function (window) {
    ...
    /* removed: const _$Repository_4 = require('./Repository') */ /* removed: const _$JSONLoader_2 = require('./JSONLoader') */ const optionsValidator =
    ...
    function appendToResultsContainer(text, isHTML = false, _isNoResults = false) {
      if (!isHTML) {
      ...
      } else options.resultsContainer.innerHTML += `${text}`;
    }
