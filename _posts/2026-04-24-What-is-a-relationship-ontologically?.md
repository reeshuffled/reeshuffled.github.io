...
<table class="cornell-table">
  <tbody>
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Relationships
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Breakups
          &amp; dissolution</span>
      </td>
    </tr>
    <tr>
      ...
      <td class="note-cell">
        <div class="note">
          <ul>
            <li>I have previously argued: <a href="{% post_url 2024-02-01-Should-breakups-ever-be-unilateral? %}">breakups should never be unilateral</a> and I still stand by this.</li>
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Speech
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Friendships
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Love
          &amp; relationships</span>
      </td>
    </tr>
    <tr>
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Intent
    ...
    <tr class="section-header-row">
      <td colspan="2"
        style="background: var(--color-background-secondary); border-top: 0.5px solid var(--color-border-primary); border-bottom: 0.5px solid var(--color-border-tertiary); padding: 4px 10px;">
        <span
          style="font-size: 11px; font-weight: 500; color: var(--color-text-secondary); letter-spacing: 0.05em; text-transform: uppercase;">Open
