...
The term Second Brain is [thought to be coined by Tiago Forte](https://stackoverflow.blog/2022/10/03/two-heads-are-better-than-one-what-second-brains-say-about-how-developers-work). A Second Brain is “a methodology for saving and systematically reminding us of the ideas, inspirations, insights, and connections we’ve gained through our experience. It provides a clear, actionable path to creating a “Second Brain” – an external, centralized, digital repository for the things you learn and the resources from which they come.” ([Forte Labs](https://fortelabs.com/blog/basboverview)). 

The Second Brain methodology is situated in the broader category of [Personal Knowledge Management Systems](https://www.arcstone.com/personal-knowledge-management-pkm-systems/), all of which try to tackle the problem of externalizing and organizing knowledge/information. It seems like the concept itself is quite old, potentially as early as the Renaissance in something called a "[commonplace book](https://www.lib.uchicago.edu/collex/exhibits/book-use-book-theory-1500-1700/parts-and-wholes-matter-method/commonplace-thinking)” of which the modern concept of the "[resonance calendar](https://aliabdaal.com/newsletter/using-notion-as-a-resonance-calendar/)" closely resembles.

I would highly recommend reading more about Second Brains as developed by Forte through [these illustrated course notes by Maggie Appleton](https://maggieappleton.com/basb).
