...
There is the work of doing philosophy which is fairly agnostic to object of thought; techniques that you could call "The Philosopher's Toolkit". I call this "[philosophical thinking]({% post_url 2024-11-26-Philosophical-Thinking %})" and believe that it is something that can be gleaned from reading philosophical literature, but I think it is best imparted on its own to be applied anywhere. While I do state it in my post about philosophical thinking, I do think it bears repeating here that it is _not_ logic that is the primary focus.

With [degree programs in the humanities shrinking, partially as a result of decreasing investment](https://www.jhunewsletter.com/article/2024/03/the-humanities-are-being-neglected-in-american-universities), I think that if we could get this into elementary/middle/high education curriculum or something else that it would do good. While the thinking skills are a bit abstract, I do not think it is that high-level/requires that much pre-requisite knowledge.
...
Philosophy has the slightly undeserved reputation of navel gazing, of being unconnected to real life. There is a grain of truth in this, with some titles reading like: *[Could the grounds’s grounding the grounded ground the grounded?](https://academic.oup.com/analysis/article-abstract/78/1/56/4079892?redirectedFrom=fulltext)* At the same time, philosophers are at the cutting edge of social thought like: *[Could a Large Language Model be Conscious?](https://arxiv.org/abs/2303.07103)* I don't mean to pass judgement on the utility of either paper examples, there is a time and place for each of them; you just have to know what kind of topics appeal to you.

I would be remiss not to address all the barriers to reading philosophy:
* Where to start?
  * [Accessible Philosophy Books]({% post_url 2026-04-05-Accessible-Philosophy-Books %})
...
* How to access?
  * [PhilPapers](https://philpapers.org/help/about.html), Academia.edu, ResearchGate will sometimes have free copies of papers.
    * Sometimes you can email the authors of the paper and ask nicely and be sent a copy.
  * [Piracy](https://netzpolitik.org/2021/academic-research-sci-hubs-fight-against-private-ownership-of-knowledge/) 😱
