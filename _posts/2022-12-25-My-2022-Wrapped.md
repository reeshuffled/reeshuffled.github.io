...
categories: Writing
permalink: /writing/2022-wrapped
...
function getEventsWithPerson(events, name) {
    return events.filter(event => {
        ...
        // otherwise the event has not attendees 
        return false;
    });
}
```
...
4. You read 101 times for 6,465 minutes or 107.75 hours. This accounts for 1.23% of the year.
