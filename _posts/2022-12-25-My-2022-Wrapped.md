...
type: article
publish_datetime: '2022-12-26T13:01:27-05:00'
links:
  internal: []
  external:
  ...
  - url: https://support.google.com/calendar/answer/37111?hl=en
    title: Export events from your Google Calendar - Google Calendar Help
  - url: https://docs.fileformat.com/email/ics/
    title: ICS - iCalendar File Format
  - url: https://github.com/jens-maus/node-ical
    title: 'GitHub - jens-maus/node-ical: Feature-rich iCalendar/ICS (RFC 5545) parser
      for Node.js · GitHub'
---
